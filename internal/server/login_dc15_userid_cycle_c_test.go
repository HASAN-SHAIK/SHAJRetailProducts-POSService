...
func TestLocalAuthLoginRejectsDC15UserIDMember(t *testing.T) {
	...
	if rec.Code != http.StatusBadRequest {
		t.Fatalf("expected DC15 user_id member to be rejected with 400, got status=%d body=%s", rec.Code, rec.Body.String())
	}
