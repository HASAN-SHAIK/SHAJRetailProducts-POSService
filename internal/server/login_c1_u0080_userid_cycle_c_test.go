...
func TestLocalAuthLoginRejectsC1U0080UserIDMember(t *testing.T) {
	...
	if rec.Code != http.StatusBadRequest {
		t.Fatalf("expected C1 U+0080 user_id member to be rejected with 400, got status=%d body=%s", rec.Code, rec.Body.String())
	}
