...
func TestLocalAuthLoginRejectsC1U0086UserIDMember(t *testing.T) {
	...
	if rec.Code != http.StatusBadRequest {
		t.Fatalf("expected C1 U+0086 user_id member to be rejected with 400, got status=%d body=%s", rec.Code, rec.Body.String())
	}
