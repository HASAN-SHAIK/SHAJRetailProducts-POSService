...
func TestLocalAuthLoginRejectsC1U0084PINMember(t *testing.T) {
	...
	if rec.Code != http.StatusBadRequest {
		t.Fatalf("expected C1 U+0084 pin member to be rejected with 400, got status=%d body=%s", rec.Code, rec.Body.String())
	}
