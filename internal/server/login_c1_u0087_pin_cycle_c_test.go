...
func TestLocalAuthLoginRejectsC1U0087PINMember(t *testing.T) {
	...
	if rec.Code != http.StatusBadRequest {
		t.Fatalf("expected C1 U+0087 pin member to be rejected with 400, got status=%d body=%s", rec.Code, rec.Body.String())
	}
